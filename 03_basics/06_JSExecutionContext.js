/* JavaScript main teen tarah ke execution context hote hain
    i) Global execution context
    ii) Function execution context
    iii) Evel execution context
*/

/*
    JavaScript ka code do phases main execute hota hai
    i) Memory creation phase
    ii) Execution phase
*/

/*
    Program kaise execute hota hain javascript main

    //aap readme file main image dekh sakte hain

    Step1:=> jab bhi koi program execute kiya jata hain to wo phale global execution main jata hai aur 'this' ko allocate hota hai.
